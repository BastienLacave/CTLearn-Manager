...
class CTLearnModelManager():
    ...
    def launch_training(self, n_epochs, transfer_learning_model_cpk=None, frozen_backbone=False):
        ...
        allowed_tels = '_'.join(map(str, ast.literal_eval(self.model_parameters_table['telescopes_ids'][0]))) if self.stereo else int(ast.literal_eval(self.model_parameters_table['telescopes_ids'][0])[0])
